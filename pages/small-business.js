  ...
  return (
    <div className="min-h-screen bg-secondary/20 overflow-x-hidden p-4">
      <div className="w-full max-w-4xl mx-auto bg-white p-4 md:p-8 rounded-lg shadow-lg overflow-hidden">
        ...
        <p>"עוסק זעיר" הוא סיווג חדש שהוגדר על ידי רשות המסים במסגרת רפורמה שנועדה להקל על עסקים קטנים בישראל. סיווג זה מאפשר לעצמאים עם מחזור עסקאות שנתי של עד 120,000 ₪ ליהנות מהקלות משמעותיות, כגון:</p>
